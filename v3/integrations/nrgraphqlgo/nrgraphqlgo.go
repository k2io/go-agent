...
// (https://godoc.org/github.com/k2io/go-agent/v3/newrelic#Transaction.NoticeError)
//
...
// newrelic.WrapHandle (https://godoc.org/github.com/k2io/go-agent/v3/newrelic#WrapHandle)
// or newrelic.WrapHandleFunc (https://godoc.org/github.com/k2io/go-agent/v3/newrelic#WrapHandleFunc)
// or you could use a New Relic integration for the web framework you are using
// if it is available (for example,
// https://godoc.org/github.com/k2io/go-agent/v3/integrations/nrgorilla)
//
// For a complete example, including instrumenting a graphql-go-handler, see:
// https://github.com/k2io/go-agent/tree/master/v3/integrations/nrgraphqlgo/example/main.go
package nrgraphqlgo
