...
// (https://godoc.org/github.com/k2io/go-agent/v3/integrations/nrnats/#StartPublishSegment)
...
// https://github.com/k2io/go-agent/blob/master/v3/integrations/nrstan/examples/main.go
package nrstan
