module github.com/k2io/go-agent/v3/integrations/nrstan/examples
...
require (
	...
	github.com/k2io/go-agent/v3/integrations/nrnats v0.0.0
...
replace github.com/k2io/go-agent/v3/integrations/nrnats => ../../nrnats/
