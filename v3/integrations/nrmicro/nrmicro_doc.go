...
// (https://godoc.org/github.com/k2io/go-agent#FromContext).
//
...
// (https://godoc.org/github.com/k2io/go-agent#Config) configuration list
...
//
// Full server example:
// https://github.com/k2io/go-agent/blob/master/v3/integrations/nrmicro/example/server/server.go
//
// Micro Clients
//
...
//
// Full client example:
// https://github.com/k2io/go-agent/blob/master/v3/integrations/nrmicro/example/client/client.go
//
// Micro Producers
//
...
// https://github.com/k2io/go-agent/blob/master/v3/integrations/nrmicro/example/pubsub/main.go
//
// Micro Subscribers
//
