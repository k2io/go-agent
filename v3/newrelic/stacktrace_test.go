...
import (
	...
	"github.com/k2io/go-agent/v3/internal/stacktracetest"
)
...
func TestStacktraceFrames(t *testing.T) {
	...
	inputFrames := []stacktraceFrame{
		{
			File: "/Users/will/Desktop/gopath/src/github.com/k2io/go-agent/v3/internal/stacktrace.go",
			Name: "github.com/k2io/go-agent/v3/internal.GetStackTrace",
			Line: 18,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/k2io/go-agent/v3/newrelic/internal_txn.go",
			Name: "github.com/k2io/go-agent/v3/newrelic.errDataFromError",
			Line: 533,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/k2io/go-agent/v3/newrelic/internal_txn.go",
			Name: "github.com/k2io/go-agent/v3/newrelic.(*txn).NoticeError",
			Line: 575,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/k2io/go-agent/v3/newrelic/transaction.go",
			Name: "github.com/k2io/go-agent/v3/newrelic.(*Transaction).NoticeError",
			Line: 90,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/k2io/go-agent/v3/examples/server/main.go",
		...
		{
			File: "/Users/will/Desktop/gopath/src/github.com/k2io/go-agent/v3/newrelic/instrumentation.go",
			Name: "github.com/k2io/go-agent/v3/newrelic.WrapHandle.func1",
			Line: 41,
		},
		{
			File: "/Users/will/.gvm/gos/go1.13/src/net/http/server.go",
		...
		{
			File: "/Users/will/Desktop/gopath/src/github.com/k2io/go-agent/v3/newrelic/instrumentation.go",
			Name: "github.com/k2io/go-agent/v3/newrelic.WrapHandleFunc.func1",
			Line: 71,
		},
		{
			File: "/Users/will/.gvm/gos/go1.13/src/net/http/server.go",
	...
	expectedJSON := `[
		{
			"name":"main.noticeError",
			"filepath":"/Users/will/Desktop/gopath/src/github.com/k2io/go-agent/v3/examples/server/main.go",
			"line":30
		},
		{
		...
		},
		{
			...
			"filepath":"/Users/will/Desktop/gopath/src/github.com/k2io/go-agent/v3/newrelic/instrumentation.go",
			"line":41
		},
		{
			"name":"http.HandlerFunc.ServeHTTP",
